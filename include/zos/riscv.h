...
#define SCAUSE_LOAD_ACCESS_FAULT 5u
#define SCAUSE_STORE_ACCESS_FAULT 7u
#define SCAUSE_INSTRUCTION_PAGE_FAULT 12u
#define SCAUSE_LOAD_PAGE_FAULT 13u
#define SCAUSE_STORE_PAGE_FAULT 15u
